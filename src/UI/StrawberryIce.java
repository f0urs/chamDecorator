 ...
 * @author Chamara
 */
public class StrawberryIce extends javax.swing.JFrame {

    public StrawberryIce() {
        initComponents();
    ...
    public void bill_print() {
        ...
        try {
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++) {
                ...
                bill.setText(bill.getText() + "- - - - - - - Strawberry Ice - - - - - - -\n");
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/strbrry.png"))); // NOI18N
        ...
        jLabel3.setText("cream, vanilla and sugar used to make ice cream.");
        ...
        jLabel15.setText("Strawberry ice cream is a flavor of ice cream made with");
        ...
        jLabel17.setText("strawberry or strawberry flavoring.It is made by blending");
        ...
        jLabel18.setText("in fresh strawberries or strawberry flavoring with the eggs,");
        ...
        jLabel2.setText("Strawberry Ice Cream");
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 100, 340, 230));
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 400, 290, 150));
        ...
        jPanel1.add(jButton14, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 590, 104, 34));
        ...
        jPanel1.add(jButton13, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 550, 104, 32));

        jLabel19.setBackground(new java.awt.Color(255, 255, 255));
        jLabel19.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        jLabel19.setForeground(new java.awt.Color(255, 51, 51));
        jLabel19.setText("Additionally Added Item");
        jPanel1.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 70, -1, -1));
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        ...
        IceCreamVarieties strawberry = new Strawberry();
        ...
        if (oreo) {
            strawberry = new Oreos(strawberry);
        }
        if (choco) {
            strawberry = new HardChocolateCoating(strawberry);
        }
        if (marshmellow) {
            strawberry = new MeltedMarshmallow(strawberry);
        }
        if (sprinkels) {
            strawberry = new Sprinkles(strawberry);
        }

        String description = strawberry.getDescription();
        System.out.println(description);
        String cost = "" + strawberry.iceCreamPrice();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StrawberryIce.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
